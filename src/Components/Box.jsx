                ...
                [...cart].reverse().map((item) => (
                  ...
                  >
                    <img
                      src={
                        item.image ||
                        "https://img.freepik.com/foto-gratis/productos-belleza-surtido-destinatarios-sobre-piedras-beige_23-2148761387.jpg?semt=ais_hybrid&w=740&q=80"
                      }
                      alt={item.name}
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      <p className="font-semibold text-gray-800">
                        $
                        {(
                          (item.price ?? item.precio) * item.quantity
                        ).toLocaleString()}
                      </p>
                    </div>
                  </div>
